...
const char http_uri6[] PROGMEM = "/favicon.ico";    // favicon Request message
const char http_uri7[] PROGMEM = "/ledon.png";
const char http_uri8[] PROGMEM = "/ledoff.png";
...
const char content_led_on_png_data[] PROGMEM = {
...
const char content_led_off_png_data[] PROGMEM = {
             0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0x00, 0x00, 0x00, 0x0D, 0x49, 0x48, 0x44, 0x52, 0x00, 0x00, 0x00, 0x0E,
...
const char * const data_for_images [] PROGMEM = { content_favicon_data, content_led_on_png_data, content_led_off_png_data }; // real data
const int size_for_images [] PROGMEM = { sizeof(content_favicon_data), sizeof(content_led_on_png_data), sizeof(content_led_off_png_data) };
// declare table for all URIs
const char * const http_uris[] PROGMEM = { http_uri1, http_uri2, http_uri3, http_uri4, http_uri5, http_uri6, http_uri7, http_uri8 }; // URIs
